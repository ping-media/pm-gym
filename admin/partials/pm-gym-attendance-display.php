...
<div class="wrap">
    ...
    <div class="date-selection">
        <form method="get" action="">
            ...
            <label for="member_id">Search:</label>
            <input type="text" id="member_id" name="member_id" value="<?php echo esc_attr($member_id); ?>" placeholder="Search by Member ID, Phone, or Name">
